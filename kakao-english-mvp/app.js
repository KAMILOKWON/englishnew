    ...
    <main class="page">
      <section class="container hero-grid">
        <div>
          ...
          <p class="lead">메시지를 받으려면 카카오톡 채널을 꼭 추가해 주세요. 채널을 추가하지 않으면 알림톡이 도착하지 않습니다.</p>
          <div class="channel-cta">
            <a class="btn primary channel-cta-btn" href="#subscribe">
              카카오 채널 추가하기
            </a>
            <p class="channel-cta-hint">채널을 추가하면 다음 발송 시간(매일 오전 8:30 예정)에 맞춰 첫 알림톡이 도착합니다. 첫 알림톡은 보통 영업일 기준 24시간 이내에 받아보실 수 있습니다.</p>
          </div>
          <div class="button-row">
            <a class="btn secondary" href="#today?date=${encodeURIComponent(message.sendDate)}">첫 표현 보기</a>
